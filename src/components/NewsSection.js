...
const NewsItem = ({ date, title, description, image, link }) => (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-4">
            ...
            <Link href={link} className="text-indigo-600 hover:text-indigo-800 text-sm mt-3 inline-block">
                Lees meer →
            </Link>
        </div>
    </div>
...
const NewsSection = () => {
    ...
    return (
        <Link href="/news" className="block bg-indigo-300 py-12 px-4 hover:bg-indigo-200 transition-colors duration-300">
